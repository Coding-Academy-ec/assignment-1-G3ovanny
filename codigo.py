...
def factorial(n):
    if n == 0:
        return 1# Escribe aqui el return de la operacion anterior
    else:
        return n * factorial(n - 1)# Escribe aqui el return de la operacion contraria a la operacion anterior
